...
{
	public partial class ModifiedScrollAndSelectList : UserControl
	{
		...
		public ModifiedScrollAndSelectList()
		{
			InitializeComponent();
		...
		private void ModifiedScrollAndSelectList_Paint(object sender, PaintEventArgs e)
		{
		...
		private void ModifiedScrollAndSelectList_MouseDown(object sender, MouseEventArgs e)
		{
  ...
  EventArgs e)
		...
		private void ModifiedScrollAndSelectList_MouseMove(object sender, MouseEventArgs e)
		{
			if (mouseDown)
			{
		...
		private void ModifiedScrollAndSelectList_MouseUp(object sender, MouseEventArgs e)
		{
			mouseDown = false;
