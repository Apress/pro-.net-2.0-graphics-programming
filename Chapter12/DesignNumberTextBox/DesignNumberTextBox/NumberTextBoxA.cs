...
namespace DesignNumberTextBox
{
	public partial class NumberTextBoxA : System.Windows.Forms.TextBox
	{
		...
		public NumberTextBoxA()
		{
			InitializeComponent();
		}

		private void NumberTextBoxA_Validating(object sender, CancelEventArgs e)
		{
			if (ContentsInRange)
			{
